...
const relationSchema = z.object({
  ...
  relationType: z.number().int().describe("RelationType: 0=Others, 1=Spouse, 2=Father, 3=Mother, 4=Child, 5=Self, 6=Sibling, 7=Partner, 8=FatherInLaw, 9=MotherInLaw. There can be multiple relations"),
  gender:       z.number().int().describe("Gender: 0=NotSpecified,1=Male,2=Female,3=Nonbinary,4=PreferNotToRespond/ Only one relation at a time"),
...
export const updatePersonalDetailsSchema = z
  .object({
    ...
    gender:             z.number().int().describe("Gender: 0=NotSpecified,1=Male,2=Female,3=Nonbinary,4=PreferNotToRespond"),
    dateOfBirth:        z.string().optional().describe("ISO 8601 birthdate. If only date is provided, it will be auto-generated as YYYY-MM-DD and time will be set to 00:00:00"),
    ...
    maritalStatus:      z.number().int().describe("MaritalStatus: 0=None,1=Single,2=Married,3=Widowed,4=Separated"),
